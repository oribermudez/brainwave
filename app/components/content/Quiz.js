...
const Quiz = ({ question, options, correctOption }) => {
  ...
  return (
    <div className="p-4 border rounded-lg border border-royal text-black w-full my-8">
      ...
      <div className={`relative`}>
        {options?.length && options.map((option, index) => (
          <div
            ...
            className={`flex items-center p-3 m-4 border border-gray-300 cursor-pointer rounded-lg hover:bg-emerald/20 ${selectedAnswer === option && !isCorrect ? 'animate-shake' : ''}`}
          >
